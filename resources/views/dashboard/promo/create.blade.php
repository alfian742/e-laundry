                                ...
                                <div class="row g-4">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="promo_name" type="text"
                                            ...
                                            value="{{ old('promo_name') }}" placeholder="Contoh: Promo Hari Raya" autofocus>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="customer_scope" id="customer_scope"
                                            ...
                                            <option value="member"
                                                {{ old('customer_scope') === 'member' ? 'selected' : '' }}>Member
                                            </option>
                                            <option value="non_member"
                                                {{ old('customer_scope') === 'non_member' ? 'selected' : '' }}>
                                                Non Member</option>
                                        </select>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="promo_type" id="promo_type"
                                            ...
                                            <option value="daily" {{ old('promo_type') === 'daily' ? 'selected' : '' }}>
                                                Harian</option>
                                            <option value="date_range"
                                                {{ old('promo_type') === 'date_range' ? 'selected' : '' }}>Periode
                                            </option>
                                        </select>
                                        <div class="invalid-feedback">
                                            @error('promo_type')
