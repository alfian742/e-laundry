...
@section('title', 'Ubah Layanan Laundry')
                                ...
                                <div class="row justify-content-center g-4">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="price_per_kg" type="text"
                                                ...
                                                name="price_per_kg"
                                                value="{{ formatRupiahPlain(old('price_per_kg', $service->price_per_kg)) }}"
                                                placeholder="1000000"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="active" id="active"
                                            ...
                                            <option value="0"
                                                {{ old('active', $service->active) == '0' ? 'selected' : '' }}>Tidak
                                                Tersedia</option>
                                        </select>
                                        <div class="invalid-feedback">
                                            @error('active')
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea name="description" id="description" rows="3"
                                            class="form-control summernote @error('description') is-invalid @enderror" placeholder="Tulis deskripsi...">{{ old('description', $service->description) }}</textarea>
                                        <div class="invalid-feedback">
                                            @error('description')
                                                {{ $message }}
                                            @enderror
                                        ...
                                        <div class="row justify-content-center align-items-center mb-4 g-4">
                                            <div class="col-sm-6">
                                                <h6 class="text-small text-center">
                                                    {{ !empty($service->img) ? 'Gambar saat ini:' : 'Belum nggah gambar' }}
                                                </h6>
                                                <!-- style sebagai parameter -->
                                                <div class="ratio ratio-4x3" style="max-width: 360px; margin: auto;">
                                                    <img src="{{ get_image_url($service->img) }}" alt="Old Image"
