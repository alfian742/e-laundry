                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class=" d-flex flex-wrap justify-content-center justify-content-sm-between align-items-center mb-4"
                                style="gap: .5rem">
                                @if ($isCustomer)
                                    <a href="{{ url('/order/services') }}" class="btn btn-secondary">Kembali</a>
                                @else
                                    <a href="{{ Str::contains(url()->previous(), url('/order/create')) ||
                                    (Str::contains(url()->previous(), '/order/') && Str::contains(url()->previous(), '/edit'))
