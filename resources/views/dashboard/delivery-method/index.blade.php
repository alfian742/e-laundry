...
@section('title', 'Metode Antar/Jemput')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class=" d-flex justify-content-between align-items-center mb-4">
                                @if ($isOwner || $isAdmin)
                                    <a href="{{ url('/delivery-method/create') }}"
                                    ...
                                    <tbody>
                                        @foreach ($deliveryMethods as $method)
                                            <tr>
                                                ...
                                                <td class="text-right">{{ formatRupiah($method->cost) }}</td>
                                                ...
                                                @if ($isOwner || $isAdmin)
                                                    <td class="text-center">
                                                        <div class="d-flex justify-content-center" style="gap: .5rem">
                                                            <a href="{{ url("/delivery-method/{$method->id}/edit") }}"
                                                            ...
                                                            @if ($method->id !== 1)
                                                                <form
                                                                    action="{{ route('delivery-method.destroy', $method->id) }}"
