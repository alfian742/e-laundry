...
@section('title', 'Ubah Metode Antar/Jemput')
        ...
        <section class="section">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('delivery-method.update', $deliveryMethod->id) }}" method="POST">
                                @csrf
                                @method('put')
                                <div class="row g-4">
                                    @if ($deliveryMethod->id === 1)
                                        <div class="form-group col-md-6">
                                            <div class="mb-2 text-dark" style="font-weight: 500; font-size: .8rem">
                                                Metode Antar/Jemput <span class="text-danger">*</span>
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-control bg-light">
                                                    {{ formatRupiahPlain($deliveryMethod->cost) }}
                                                </div>
                                            </div>
                                        </div>
                                    @else
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="method_name" type="text"
                                                ...
                                                name="method_name"
                                                value="{{ old('method_name', $deliveryMethod->method_name) }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="cost">Biaya Pengiriman <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text bg-light">Rp</span>
                                                ...
                                                <input id="cost" type="text"
                                                    ...
                                                    value="{{ old('cost', formatRupiahPlain($deliveryMethod->cost)) }}"
                                                    placeholder="1000000">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea name="description" id="description" rows="3"
                                            class="form-control @error('description') is-invalid @enderror" placeholder="Tulis keterangan singkat...">{{ old('description', $deliveryMethod->description) }}</textarea>
                                        <div class="invalid-feedback">
                                            @error('description')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="active" id="active"
                                            ...
                                            <option value="1"
                                                {{ old('active', $deliveryMethod->active) == '1' ? 'selected' : '' }}>
                                                Tersedia
                                            </option>
                                            <option value="0"
                                                {{ old('active', $deliveryMethod->active) == '0' ? 'selected' : '' }}>Tidak
                                                Tersedia</option>
                                        </select>
                                        <div class="invalid-feedback">
                                            @error('active')
