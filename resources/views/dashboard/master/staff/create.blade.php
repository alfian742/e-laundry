                                ...
                                <div class="row g-4">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="fullname" type="text"
                                            ...
                                            value="{{ old('fullname') }}" placeholder="Jane Doe">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="base_salary" type="text"
                                                ...
                                                name="base_salary" value="{{ old('base_salary') }}" placeholder="1000000">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="bonus_salary" type="text"
                                                ...
                                                name="bonus_salary" value="{{ old('bonus_salary') }}"
                                                placeholder="1000000">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="deductions_salary" type="text"
                                                ...
                                                name="deductions_salary" value="{{ old('deductions_salary') }}"
                                                placeholder="1000000">
