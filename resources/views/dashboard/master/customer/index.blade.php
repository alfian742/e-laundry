                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class=" d-flex justify-content-between align-items-center mb-4">
                                <form method="GET" action="{{ route('customer.index') }}" style="width: 13rem">
                                    <div class="input-group">
                                        ...
                                        <select class="custom-select" name="filter" id="filter"
                                            ...
                                            <option value="member" {{ $filter === 'member' ? 'selected' : '' }}>Member
                                            </option>
                                            <option value="non_member" {{ $filter === 'non_member' ? 'selected' : '' }}>
                                                Non-Member
                                            </option>
                                        </select>
                                    </div>
                                ...
                                @if ($isOwner || $isAdmin)
                                    <a href="{{ url('/customer/create') }}" class="btn btn-primary ml-auto">Tambah</a>
                                @endif
                            </div>
