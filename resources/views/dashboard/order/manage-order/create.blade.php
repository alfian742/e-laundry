                                    ...
                                    <div class="col-12">
                                        <div class="alert bg-light text-dark mb-4" role="alert">
                                            ...
                                            <p class="text-lead mb-0">
                                                ...
                                                yang berlaku (Harian atau Periode tertentu) dengan diskon yang paling besar.
                                                Anda juga dapat mengatur promo secara manual jika diperlukan.
                                            </p>
                                        </div>

                                        <form action="{{ route('order.checkout.staff', $order->id) }}" method="POST">
                                            @csrf
                                            @method('put')
