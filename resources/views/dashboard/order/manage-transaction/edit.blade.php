                ...
                @if ($isCustomer)
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <form
                                    action="{{ route('transaction.order.update', ['order' => $order->id, 'transaction' => $transaction->id]) }}"
                                    ...
                                    <div class="d-none visible-field-online visible-field-bank_transfer">
                                        <div id="img-preview">
                                            ...
                                            <div class="ratio ratio-3x4" style="max-width: 360px; margin: auto;">
                                                <img src="{{ get_image_url($transaction->relatedProof?->img) }}"
                                                    alt="New Image" loading="lazy" class="rounded d-block w-100 h-100"
                                    ...
                                    <div class="row justify-content-center g-4">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="amount_paid" type="text"
                                                    ...
                                                    name="amount_paid"
                                                    value="{{ formatRupiahPlain(old('amount_paid', $transaction->amount_paid)) }}"
                                                    data-old-value="{{ formatRupiahPlain($transaction->amount_paid) }}"
                                                    placeholder="1000000"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea name="notes" id="notes" rows="3" class="form-control @error('notes') is-invalid @enderror"
                                                placeholder="Tulis keterangan singkat...">{{ old('notes', $transaction->notes) }}</textarea>
                                            <div class="invalid-feedback">
                                                @error('notes')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="col-12">
                                            ...
                                            @php
                                                ...
                                                $availableProof =
                                                    in_array($paymentMethod->payment_type, [
                                                        'online',
                                                        'bank_transfer',
                                                    ]) && $proof?->img !== null;
                                            @endphp
                                            ...
                                            <div
                                                class="row  {{ $availableProof ? 'justify-content-between' : 'justify-content-end' }} mb-4">
                                                @if ($availableProof)
                                                    <div class="col-md-6">
                                                        <div class="chocolat-parent mb-4 mb-md-0">
                                                            <a href="{{ get_image_url($proof?->img) }}"
                                                                ...
                                                                <div class="ratio ratio-1x1"
                                                                    ...
                                                                    <img src="{{ get_image_url($proof?->img) }}"
                                                                        alt="{{ $proof?->img }}" loading="eager"
    ...
    @else
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const oldAmountPaid = parseInt(amountPaidInput.dataset.oldValue || '0');
                ...
                amountPaidInput.addEventListener('input', function() {
                    ...
                    const additionalPaid = newAmountPaid - oldAmountPaid;
                    const updatedTotalAmountPaid = totalAmountPaid + additionalPaid;

                    additionalPaidDisplay.textContent = formatToRupiah(additionalPaid);
                ...
                // Jalankan saat awal jika input sudah ada isinya
