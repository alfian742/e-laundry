                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea name="notes" id="notes" rows="3" class="form-control @error('notes') is-invalid @enderror"
                                            placeholder="Tulis keterangan...">{{ old('notes') }}</textarea>
                                        <div class="invalid-feedback">
                                            @error('notes')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="total_amount" type="text"
                                                ...
                                                name="total_amount" value="{{ old('total_amount') }}" placeholder="1000000">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="paid_amount" type="text"
                                                ...
                                                name="paid_amount" value="{{ old('paid_amount') }}" placeholder="1000000">
